...
::alert{type=info}
**Mandatory seeds and adapters.** Please, refer to the [seeds and adapters' documentation](/en/using/configuration/adapts-seeds) to get information about the way a seed or an adapter should be implemented.
::
...
::alert{type=warning}
Please refer to the [adapter documentation](/en/using/configuration/adapts-seeds) to get information about the way an adapter should be implemented.
::
