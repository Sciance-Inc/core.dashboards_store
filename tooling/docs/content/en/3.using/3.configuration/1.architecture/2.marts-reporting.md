...
It can be intentionally denormalized. A reporting table can repeat labels, embed thresholds, precompute variations, and directly expose the columns required by a Power BI page.
...
| --- | --- | --- |
| Role | Govern analytical truth. | Serve one or more Power BI reports. |
...
| Grain | Strict and documented. | Adapted to the needs of the visual or report. |
...
| Risk to avoid | Too much local logic, or too many presentation columns. | Becoming a second business truth. |

## Kimball and OBT are not opposed here

In this architecture, Kimball and OBT are not competing choices.

They happen at two different stages in the flow:
...
It should be promoted to a mart when it becomes reusable, stable, or structural.
