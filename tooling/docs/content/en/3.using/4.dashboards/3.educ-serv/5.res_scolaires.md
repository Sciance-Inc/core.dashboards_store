...
::alert{type=info}
Provides a quick overview of the results of the selected academic subjects and skills of the school board.
::
...
> The threshold is used to identify overachieving students. It is set to 70% by default.
