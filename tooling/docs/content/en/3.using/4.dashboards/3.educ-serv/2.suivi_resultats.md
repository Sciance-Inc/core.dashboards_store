...
The dashboard also provides an annual portrait of the school. To include course grades, you need to activate the table `core.dashboards_store/models/dashboards/educ_serv/res_scolaires/pbi_tables/resco_report_res_bilan_comp_eco.sql`.
::
