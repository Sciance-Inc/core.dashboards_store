...
Le tableau de bord nécessite les seeds suivantes : `etat_empl`, `type_absence`, `secteur`, `heure_quotidienne` et `code_paiement`. Veuillez consulter la section sur l'amorçage [seeding](/en/using/configuration/adapts-seeds) pour plus d'informations sur l'amorçage d'un mart. Ces seeds sont nécessaires pour catégoriser les absences et les employés. Comme vous n'aurez pas besoin de les remplacer, vous pouvez simplement exécuter la commande suivante pour créer les seeds :
