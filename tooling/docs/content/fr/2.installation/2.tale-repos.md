...
3. Initialisez un nouveau *repo* `cssXX.dashboards_store` à partir du *template* du *Core*.
   ::alert{type="info"}
...
4. Suivons les bonnes pratiques et utilisons Git pour le *repo* que vous venez de créer.
...
5. Lisez `cssXX.dashboards_store/README.md` pour en savoir plus sur les étapes de post-configuration nécessaires au bon fonctionnement du projet.
