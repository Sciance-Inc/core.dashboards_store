...
2. Je remplace ensuite la variable `database_paie` par le nom de ma base de données. Consultez la section [lier une base de données](/fr/using/configuration/databases) pour plus d'informations.
