...
1. Je crée d'abord un fichier sous `cssXX.dashboards_store/models/marts/educ_serv/stg_ele_prescolaire.sql`. Notez que le fichier est créé dans `cssXX` avec le même nom que celui du fichier de définition.
