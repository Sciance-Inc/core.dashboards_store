...
::alert{info}
Pour configurer le *dashboard*, vous devrez peut-être faire de l'*overriding*. Si le concept est nouveau pour vous, consultez [cette page](/fr/using/configuration/overriding).
::
