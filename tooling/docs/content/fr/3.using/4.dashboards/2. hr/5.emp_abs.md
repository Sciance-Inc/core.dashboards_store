...
## *Seeds*
Le tableau de bord nécessite les *seeds* suivantes: `etat_empl`, `type_absence`, `secteur`, `heure_quotidienne` et `code_paiement`. Consultez la section [*seeds*](/fr/using/configuration/adapts-seeds) pour plus d'informations sur l'alimentation d'un *mart*. Ces *seeds* sont nécessaires pour catégoriser les absences et les employés. Comme vous n'aurez pas besoin de les remplacer, vous pouvez simplement exécuter la commande suivante pour les créer:
