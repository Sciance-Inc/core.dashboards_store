...
Les seeds etat_empl et type_absence sont décrites à cet endroit : `seeds/marts/human_resources/schema.yml`
...
Les seeds secteur et heure_quotidienne sont décrites à cet endroit : `seeds/dashboards/human_resources/schema.yml`   
 ### secteur
