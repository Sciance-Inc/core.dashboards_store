...
::alert{type=warning}
Please refer to the [adapter documentation](/using/configuration/adapts-seeds) to get information about the way an adapter should be implemented.
::
...
::alert{info}
Please read about [overriding](/using/configuration/overriding) if you are new to the concept.
::
