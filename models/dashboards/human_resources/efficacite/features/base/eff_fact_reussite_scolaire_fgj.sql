...
with
    ...
    res_primaire as (
        select fiche, annee, res_etape_num
    ...
    resultat_union as (
        ...
        from source ele
        inner join
            {{ ref("rstep_fact_epreuves_uniques") }} res  -- res secondaire seulement
        ...
        from source ele
        inner join
            res_primaire as res on ele.fiche = res.fiche and ele.annee = res.annee
