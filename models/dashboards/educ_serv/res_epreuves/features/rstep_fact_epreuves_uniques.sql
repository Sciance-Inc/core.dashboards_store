...
{#
    Fetch the var("dashboards")["res_epreuves"]["cod_css"]  variable
#}
{% set cod_css = var("dashboards")["res_epreuves"]["cod_css"] %}
{% if not cod_css %}
    {{
        log(
            "The code_css variable must be set for the res_epreuves dashboards to work. Please set it.",
            true,
        )
    }}
{% endif %}
